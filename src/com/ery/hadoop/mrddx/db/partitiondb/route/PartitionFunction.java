...
import com.ery.hadoop.mrddx.util.SplitUtil;

public abstract class PartitionFunction {
	public PartitionFunction(int[] count, int[] length) {
		this.count = count;
		this.length = length;
		init();
	}
	...
	public int getPartitionLength() {
		return partitionUtil.segmentLength;
	}
	...
	public abstract Integer calculate(Object parameters);
