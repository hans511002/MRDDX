...
public class LineReaders {
	 ...
	 * @throws IOException
	 */
	public LineReaders(InputStream in) {
	 ...
	 * @throws IOException
	 */
	public LineReaders(InputStream in, int bufferSize) {
		this.in = in;
	 ...
	 *            The delimiter
	 */
	public LineReaders(InputStream in, byte[] recordDelimiterBytes) {
		this.in = in;
	 ...
	 * @throws IOException
	 */
	public LineReaders(InputStream in, int bufferSize, byte[] recordDelimiterBytes) {
		this.in = in;
		this.bufferSize = bufferSize;
		this.buffer = new byte[this.bufferSize];
		this.recordDelimiterBytes = recordDelimiterBytes;
	...
	public int readLine(Text str, int maxLineLength, int maxBytesToConsume) throws IOException {
		// if (!isreadtar && in instanceof TarInputStream){// 获取tar包的�?��
		// isreadtar = true;
		// ((TarInputStream)in).getNextEntry();
		// }
		...
		int readsize = -1;
		if (!isreadtar && in instanceof TarInputStream) {
			isreadtar = true;
