...
public class VerticaConfiguration {
	...
	public static final String HOSTNAMES_PROP = "input.mapred.vertica.hostnames";

	/** Name of database to connect to */
	public static final String DATABASE_PROP = "input.mapred.vertica.database";

	/** User name for Vertica */
	public static final String USERNAME_PROP = "input.mapred.vertica.username";

	/** Password for Vertica */
	public static final String PASSWORD_PROP = "input.mapred.vertica.password";

	/** Port for Vertica */
	public static final String PORT_PROP = "input.mapred.vertica.port";
	...
	/** Host names to connect to, selected from at random */
	public static final String OUTPUT_HOSTNAMES_PROP = "output.mapred.vertica.hostnames";

	/** Name of database to connect to */
	public static final String OUTPUT_DATABASE_PROP = "output.mapred.vertica.database";

	/** User name for Vertica */
	public static final String OUTPUT_USERNAME_PROP = "output.mapred.vertica.username";

	/** Password for Vertica */
	public static final String OUTPUT_PASSWORD_PROP = "output.mapred.vertica.password";

	/** Password for Vertica */
	public static final String OUTPUT_PORT_PROP = "output.mapred.vertica.port";
	...
	/** Output table name */
	public static final String OUTPUT_TABLE_NAME_PROP = DBConfiguration.OUTPUT_TABLE_NAME_PROPERTY;
	 ...
	 */
	public static void configureVertica(Configuration conf, String[] hostnames, String database, String port,
			String username, String password, String debug, String[] output_hostnames, String output_database,
			String output_port, String output_username, String output_password) {
		configureVertica(conf, hostnames, database, port, username, password, debug);
	...
	public Connection getConnection(boolean output) throws IOException, ClassNotFoundException, SQLException {
		...
		return DriverManager.getConnection("jdbc:vertica://" + hosts[r.nextInt(hosts.length)] + ":" + port + "/"
				+ database, user, pass);
	}
	...
	/**
	 * Query used to retrieve parameters for the input query. The result set
	 * must match the input query parameters preceisely.
	 * 
	...
	/**
	 * Sets a collection of lists. Each list is passed to an input split and
	 * used as arguments to the input query.
	 * 
	 * @param segmentParams
	 * @throws IOException
	 */
	...
	/**
	 * @deprecated As of release 1.5, this function is not called from the Java
	 *             API. For streaming set the delimiter to separate values to
	 *             the mapper
	 */
	@Deprecated
	...
	/**
	 * For streaming return the record terminator to separate values to the
	 * mapper
	 * 
	...
	/**
	 * @deprecated As of release 1.5, this function is not called from the Java
	 *             API. For streaming set the record terminator to separate
	 *             values to the mapper
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of release 1.5, this function is not called from the Java
	 *             API. For streaming set the delimiter used by the reducer
	 * 
	 * @param delimiter
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of release 1.5, this function is not called from the Java
	 *             API. For streaming set the record terminator used by the
	 *             reducer
	 * 
	 * @param terminator
	 */
	...
	/**
	 * @deprecated As of release 1.5, this function is not called from the Java
	 *             API. Returns poll timer for optimize loop
	 * 
	...
	/**
	 * @deprecated As of release 1.5, this function is not called from the Java
	 *             API. Set the timour for the optimize poll loop
	 * 
	 * @param timeout
	 */
	@Deprecated
